...
| J2735 | SAE J2735 — V2X message dictionary. |
| J3016 | SAE Levels of Driving Automation |
| LFM | Latent Fault Metric |
| MAP | Mapping or index artifact. |
| MRC | Minimal Risk Condition |
| MSA | Measurement Systems Analysis |
| NCAP | Network Capable Application Processor. |
| OBD-II | Governed term in this scope vocabulary. |
| ODD | Operating Design Domain |
| OEDR | Object and Event Detection and Response |
| OS | Operating system. |
| OTA | Over-the-Air |
| PC5 | PC5 sidelink interface (V2X). |
| PFMEA | Process Failure Mode and Effects Analysis. |
| PKI | Governed term in this scope vocabulary. |
| PMHF | Probabilistic Metric for Random Hardware Failures |
| PPAP | Production Part Approval Process |
| PSW | Part Submission Warrant (PPAP). |
| R127 | UNECE R127 — Pedestrian safety. |
| R13 | UNECE R13 — Heavy vehicle braking. |
| R13-H | UNECE R13-H — Passenger vehicle braking. |
| R137 | UNECE R137 — Frontal impact with focus on restraint systems. |
| R155 | UNECE R155 — Cybersecurity management system. |
| R156 | UNECE R156 — Software update management system. |
| R157 | UNECE R157 — Automated Lane Keeping Systems. |
| R79 | UNECE R79 — Steering equipment. |
| R94 | UNECE R94 — Frontal collision protection. |
| R95 | UNECE R95 — Lateral collision protection. |
