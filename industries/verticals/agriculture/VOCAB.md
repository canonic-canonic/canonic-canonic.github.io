...
| EM38 | Governed term in this scope vocabulary. |
...
| GPS- | GPS-related agricultural precision reference. |
| GS1 | Governed term in this scope vocabulary. |
...
| J1194 | SAE J1194 — standard. |
| J2194 | SAE J2194 — standard. |
| LGMA | Governed term in this scope vocabulary. |
| NOP | Governed term in this scope vocabulary. |
| NOP-2603 | USDA National Organic Program section 2603. |
...
| RTK-GPS | Real-Time Kinematic GPS — centimeter-precision positioning. |
| RUP | Governed term in this scope vocabulary. |
| S276 | Section 276 regulatory reference. |
| S445 | Section 445 regulatory reference. |
...
| USDA- | United States Department of Agriculture reference. |
| VRA | Governed term in this scope vocabulary. |
| WGS84 | Governed term in this scope vocabulary. |
