...
**FFI = Foreign function interface. Kernel. Bare metal.**
...
| Peer Languages | EVIDENCE, python, swift, typescript |
...
```
c → SDK                Language SDK for MAGIC primitives
