...
1. **Identify declarations** — what does this tradition claim as sacred?
2. **Map evidence** — what texts/traditions support those claims?
3. **Trace history** — when did these claims arise and how did they evolve?
4. **Define community** — who is in, who is out, how does one enter/leave?
5. **Document practice** — what behavior is required, forbidden, encouraged?
6. **Describe institutions** — what structures persist across generations?
...
```
MUST:     Cite declared sacred text for doctrinal claims
MUST:     Distinguish binding doctrine from interpretive tradition
MUST NOT: Present one tradition's claims as universal across all religions
```

---

*RELIGION | CANON | VERTICALS*
