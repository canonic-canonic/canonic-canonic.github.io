...
| Term | Definition |
|------|-----------|
| AC500-S | ABB AC500-S — safety PLC. |
...
| F-CPU | Fail-safe CPU for automotive safety controllers. |
...
| H2S | Hydrogen Sulfide — toxic gas monitoring. |
| HMI | Human-Machine Interface |
| IACS- | International Association of Classification Societies reference. |
...
| ISA-88 | ISA-88 — Batch Control standard. |
...
| SIL- | Safety Integrity Level reference. |
