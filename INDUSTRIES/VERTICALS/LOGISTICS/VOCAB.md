...
| C-TPAT | Governed term in this scope vocabulary. |
...
| E- | E-prefixed standard reference. |
...
| GS1-128 | GS1-128 — supply chain barcode standard. |
...
| ICS2 | Governed term in this scope vocabulary. |
...
| NP- | NP-prefixed standard reference. |
| OBD-II | Governed term in this scope vocabulary. |
| OR- | OR-prefixed standard reference. |
| PCC | Point of Common Coupling. |
| R15 | UNECE R15 — Emission control. |
| R2 | Governed term in this scope vocabulary. |
| R3 | UNECE R3 — Retro-reflecting devices. |
...
| US- | US-prefixed regulatory reference. |
