...
| C-RAC | Governed term in this scope vocabulary. |
...
| EU- | EU-prefixed regulatory reference. |
...
| JSON-LD | JSON for Linked Data — semantic web format. |
...
| OIDC- | OpenID Connect authentication protocol reference. |
...
| XML- | XML-prefixed standard reference. |
