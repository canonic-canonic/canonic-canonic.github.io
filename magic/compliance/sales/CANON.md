...
| Lane | SALES |
| Parent | COMPLIANCE |
| Primary Primitive | CHAT |
| Primitives | INTEL + CHAT + COIN (all three; CHAT leads) |
| Peer Lanes | EVIDENCE, GTM, MARKET |
...
```
SALES → COMPLIANCE    Tier algebra enforcement
CHAT → SALES     Primary primitive binding
```

---

*SALES | SPEC | ECOSYSTEM*
